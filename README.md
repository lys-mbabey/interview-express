...
- [ ] /route1 should check the request for the presence of an Authorization header with the value "Bearer 1234" and should respond with an appropriate error code if it does not exist. This response does not need to contain a body.
