...
- [ ] /route1 should check the request for the presence of an Authorization header with the value "Bearer 1234" and should return an appropriate error code if it does not exist.
- [ ] /route1 and /route2 should attach a response header "Date" that is the time UTC time the request was received.
